...
public class DetailsController
{
   ...
   private DetailsService detailsService;
    ...
    private String searchUser(Model model,Details detail)
    {
        Details detailSearch= detailsService.findByUser(detail.getName());
        model.addAttribute("detail",detailSearch);
        return "display";
    }
